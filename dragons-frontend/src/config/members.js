...
export const MEMBERS = [
  ...
  },
  {
    ...
    fullName: '牛可心',
    mbti: 'ENFJ（E属性很低）',
    intro: '三大摄影之一，狮猫互娱集团首席超模\n在镜头后默默付出的社恐奉献牛，办公室里的牛肉干终结者',
    hobbies: '长得帅的男的',
    talents: '拍摄、剪辑、立人设',
    specialties: '唱歌、模特步',
  ...
  },
  {
    ...
    fullName: '段紫荆',
    mbti: 'ISFP',
    intro: '三大摄影之一，紫荆解忧杂货铺CEO，说话特别慢的rapper\n社会没有参天树，我叫小段你记住',
    hobbies: '爱吃东西',
    talents: '说话特别慢',
    specialties: '说唱',
    dream: '逛遍全世界',
  ...
  },
  {
    ...
    fullName: '郭茜茜',
    mbti: 'ENFP',
    intro: '后浪气血最足的女人，剁椒鱼头车主，未来的幼儿园园长，可能成为小米的雇主\n疑似是因为家太远很少被强开所以气血充沛',
    hobbies: '小孩',
    talents: '特别擅长带小孩',
  ...
  },
  {
    ...
    fullName: '翟京凯',
    mbti: 'INTJ',
    intro: '啾咪组合成员，最有信念感的poping舞者，男人帮最容易反水者\n初始刷新点为路边，后随机刷新在台球厅和大洋\n',
    hobbies: '上网、台球',
    talents: '台球',
    specialties: '机械舞',
    dream: '环游世界',
